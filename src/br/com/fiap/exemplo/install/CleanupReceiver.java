package br.com.fiap.exemplo.install;
...
import br.com.fiap.exemplo.common.dao.DataSource ;
import br.com.fiap.exemplo.util.log.HandlerLog ;
...
public class CleanupReceiver extends BroadcastReceiver
{
	...
	public void onReceive( Context context, Intent intent )
	{
		...
		if( intent.getAction().equals( Intent.ACTION_PACKAGE_REMOVED ) )
		{
			...
			if ( br.com.fiap.exemplo.util.Environment.DEVELOPMENT )
			{
