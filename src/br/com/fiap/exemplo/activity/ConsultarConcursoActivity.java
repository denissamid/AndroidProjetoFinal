package br.com.fiap.exemplo.activity ;
...
import br.com.fiap.exemplo.action.BuscaConcursoACT ;
import br.com.fiap.exemplo.common.vo.JogoVO ;
import br.com.fiap.exemplo.common.vo.Sorteio ;
import br.com.fiap.exemplo.util.InternetConnection ;
...
public class ConsultarConcursoActivity extends Activity implements Runnable
{
	...
	public void obterDadosDoConcurso( )
	{
		...
		if (InternetConnection.verificandoConexao( contexto ))
		{
	...
	public void run( )
	{
		...
		try
		{
			BuscaConcursoACT buscaConcurso = new BuscaConcursoACT( URL ) ;
